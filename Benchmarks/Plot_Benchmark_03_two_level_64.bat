...
"%GQIS_PYTHON%" Benchmark_03_plot_from_csv.py --csv "results\Benchmark_03_two_level_64_metrics.csv" --solvers gqis_rk4 gqis_tsit5 gqis_dop853 julia_gpu_fp64 julia_gpu_fp32_fopt julia_gpu_fp32 qutip_cpu
