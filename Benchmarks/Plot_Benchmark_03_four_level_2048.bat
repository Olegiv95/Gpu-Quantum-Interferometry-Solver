...
"%GQIS_PYTHON%" Benchmark_03_plot_from_csv.py --csv "results\Benchmark_03_four_level_2048_metrics.csv" --solvers gqis_rk4 gqis_ab5 gqis_anas5 gqis_tsit5 gqis_dop853 julia_gpu_fp32_fopt julia_gpu_fp32
