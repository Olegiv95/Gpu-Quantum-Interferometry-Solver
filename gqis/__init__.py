...
__all__ = ["build_independent_rho", "build_reduced_lindblad_rhs", "mesolve_2D", "odesolve_2D"]
...
def __getattr__(name: str):
    ...
    try:
        solver = import_module(".gqis_ode_api" if name == "odesolve_2D" else ".solver", __name__)
